...
from core_scripts.multi_timeframe_analyzer import MultiTimeframeAnalyzer
from core_scripts.volume_analyzer import VolumeAnalyzer
from core_scripts.entry_filter_system import EntryFilterSystem

# Import existing modules
try:
    from data_modules.technical_analyzer import AppleTechnicalAnalyzer
except ImportError:
    from technical_indicators_wrapper import AppleTechnicalAnalyzer
...
class SwingTradingAnalyzer:
    ...
    def _save_analysis_results(self, all_results, valid_trades):
        ...
        os.makedirs('outputs/swing_trades', exist_ok=True)
        
        # Save all results
        filename = f'outputs/swing_trades/analysis_{timestamp}.json'
