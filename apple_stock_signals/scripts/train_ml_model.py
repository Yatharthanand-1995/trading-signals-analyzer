...
def train_all_models():
    ...
    if trained:
        ...
        summary_file = f"ml_models/training_reports/training_summary_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print("   python3 core_scripts/ml_enhanced_analyzer.py")
        print("\n2. Or use the command:")
        print("   python3 core_scripts/ml_enhanced_analyzer.py --paper")
        print("\n3. To analyze specific stock:")
        print("   python3 core_scripts/ml_enhanced_analyzer.py --symbol AAPL")
    else:
